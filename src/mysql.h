...
/*
	SOME NICE THINGS TO TAKE A LOOK:

	Query formatting:
	https://github.com/boostorg/mysql/pull/213#pullrequestreview-1890118842
...
constexpr auto tuple_awaitable = boost::asio::experimental::as_tuple(boost::asio::use_awaitable);
