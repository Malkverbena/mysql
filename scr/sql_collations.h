...
#ifndef SQLCOLLATIONS_H
#define SQLCOLLATIONS_H
...
class SqlCollations : public RefCounted {
	GDCLASS(SqlCollations, RefCounted);
...
VARIANT_ENUM_CAST(SqlCollations::mysql_collations);
VARIANT_ENUM_CAST(SqlCollations::ssl_mode);
VARIANT_ENUM_CAST(SqlCollations::CONN_TYPE);
